package com.arith.demo.endpoint.rest.controller.health;

import static com.arith.demo.file.hash.FileHashAlgorithm.NONE;
import static java.io.File.createTempFile;
import static java.nio.file.Files.createTempDirectory;
import static java.util.UUID.randomUUID;

import com.arith.demo.PojaGenerated;
import com.arith.demo.file.bucket.BucketComponent;
import com.arith.demo.file.hash.FileHash;
import java.io.File;
